...
public class DialogoParticiones2 extends JFrame {
    ...
    public void inicializarPaneles(int cantidadParticiones){
    	for (int i = 0; i < cantidadParticiones; i++) {
        	PanelLayout panel = new PanelLayout(null, "Tamanio para la Particion # " + String.valueOf(i+1), "Escriba el tamano de memoria de la particion # " + String.valueOf(i +1), TipoPanel.particion);
